...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        p { line-height: 1.65; color: #817775; }
        label { display: block; margin: 22px 0 8px; color: #504846; font-size: 13px; font-weight: 600; }
        ...
        button { width: 100%; margin-top: 20px; border: 0; border-radius: 12px; padding: 14px 20px; background: #8f0e16; color: #fff; cursor: pointer; font: inherit; font-weight: 700; transition: background .2s ease, transform .2s ease; }
        button:hover { background: #721018; transform: translateY(-1px); }
        a { display: block; margin-top: 22px; color: #8f0e16; text-align: center; font-size: 14px; font-weight: 700; text-decoration: none; }
        a:hover { text-decoration: underline; }
        .message { padding: 12px 14px; border-radius: 12px; background: #edf8f0; color: #23613b; font-size: 14px; }
        .error { padding: 12px 14px; border-radius: 12px; background: #fff1f0; color: #9b1c1c; font-size: 14px; }
