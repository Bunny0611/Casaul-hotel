    ...
    <div class="calendar-toolbar px-4 py-3 sm:px-5">
        <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div class="flex items-center gap-2">
                <a href="{{ route('employee.calendar', ['date' => $calendarStart->copy()->subWeek()->format('Y-m-d')]) }}" class="toolbar-btn h-10 w-10 flex items-center justify-center">
                    <i class="fas fa-chevron-left"></i>
                </a>
                <a href="{{ route('employee.calendar', ['date' => $calendarStart->copy()->addWeek()->format('Y-m-d')]) }}" class="toolbar-btn h-10 w-10 flex items-center justify-center">
                    <i class="fas fa-chevron-right"></i>
                </a>
                <a href="{{ route('employee.calendar', ['date' => now()->format('Y-m-d')]) }}" class="toolbar-btn px-3 py-2 text-sm font-medium ml-2">Today</a>
