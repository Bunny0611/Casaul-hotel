    ...
    <div class="dining-container">
        ...
        <section class="dining-menu" id="menu">
            ...
            <div class="dining-dishes">
                <article class="dining-dish-card">
                    ...
                    <div class="dining-dish-copy"><h3>Signature Platter</h3><p>Chef's special mix of seasonal favorites.</p><a href="#dining-experience">Explore Menu <span aria-hidden="true">-&gt;</span></a></div>
                </article>
                <article class="dining-dish-card">
                    <img src="{{ asset('image/HM.jpg') }}" alt="Fresh and bright dish">
                    <div class="dining-dish-copy"><h3>Fresh &amp; Bright</h3><p>Light, flavorful options made with fresh ingredients.</p><a href="#dining-experience">Explore Menu <span aria-hidden="true">-&gt;</span></a></div>
                </article>
                <article class="dining-dish-card">
                    <img src="{{ asset('image/Royal-Suite-room.jpg') }}" alt="Sweet dessert finale">
                    <div class="dining-dish-copy"><h3>Sweet Finale</h3><p>End your day with delightful desserts.</p><a href="#dining-experience">Explore Menu <span aria-hidden="true">-&gt;</span></a></div>
                </article>
            </div>
        </section>
        ...
        <section class="dining-experience" id="dining-experience">
            <div class="dining-experience-copy">
                ...
                <div class="dining-booking"><i class="far fa-calendar-check"></i><div><strong>Planning a special occasion or group dining?</strong><span>We're here to make it memorable.</span></div><a href="{{ route('reservation') }}">Book a Table <span aria-hidden="true">-&gt;</span></a></div>
            </div>
