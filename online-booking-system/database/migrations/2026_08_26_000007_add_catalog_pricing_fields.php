...
return new class extends Migration
{
    ...
    {
        Schema::table('facilities', fn (Blueprint $table) => $table->dropColumn(['pricing_basis', 'capacity', 'scheduling_requirement']));
        Schema::table('events', fn (Blueprint $table) => $table->dropColumn(['event_type', 'pricing_basis']));
    }
};